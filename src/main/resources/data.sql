insert into users(name, email, address, phone, password, regdate, use) values ('sungpark', 'urstory@gmail.com', '서울시 강동구', '010-2554-4745', '{bcrypt}$2a$10$YawlEecaIvN5xMW7886JhOj6Iuy..f.XfoGy8/vJCW/5iRQlP3pzy', now(), 'Y');
insert into users(name, email, address, phone, password, regdate, use) values ('lee', 'lee@gmail.com', '서울시 송파구', '010-8746-2645','{bcrypt}$2a$10$YawlEecaIvN5xMW7886JhOj6Iuy..f.XfoGy8/vJCW/5iRQlP3pzy', now(), 'Y');
insert into users(name, email, address, phone, password, regdate, use) values ('kim', 'admin@gmail.com', '서울시 강서구', '010-6544-9425','{bcrypt}$2a$10$YawlEecaIvN5xMW7886JhOj6Iuy..f.XfoGy8/vJCW/5iRQlP3pzy', now(), 'Y');
